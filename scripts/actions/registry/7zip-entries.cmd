...
reg add "HKU\%SID%\Software\7-Zip\FM\Columns" /v "RootFolder" /t REG_BINARY /d "0100000000000000010000000400000001000000A0000000" /f 
reg add "HKU\%SID%\Software\7-Zip\Options" /v "ElimDupExtract" /t REG_DWORD /d "0" /f 
reg add "HKU\%SID%\Software\7-Zip\Options" /v "ContextMenu" /t REG_DWORD /d "4100" /f 
