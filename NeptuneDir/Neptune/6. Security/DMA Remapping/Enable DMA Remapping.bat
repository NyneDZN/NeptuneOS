...
Reg add "%%a" /v "DmaRemappingCompatible" /t Reg_DWORD /d "1" /f >nul 2>&1
)
:: Echo to Log
cls
echo %date% %time% Enabled DMA Remapping >> %userlog%
:: Echo to User
echo !S_YELLOW!DMA Remapping has been enabled. Please restart your device.
