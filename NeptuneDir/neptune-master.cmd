...
%WinDir%\NeptuneDir\Tools\%system% /SW:0 regedit.exe /s "%WinDir%\NeptuneDir\neptune.reg" >nul 2>&1
...
%currentuser% Reg add "HKCU\Control Panel\Desktop" /v "FontSmoothing" /t REG_SZ /d "0" /f >nul 2>&1
...
:: Set kernel priority to realtime (experimental)
...
Reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\vgc.exe" /v "MitigationOptions" /t REG_BINARY /d "00000000000100000000000000000000" /f >nul 2>&1
