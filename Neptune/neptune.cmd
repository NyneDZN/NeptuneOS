...
:: Refresh Enviornment
call "%neptunemain%RefreshEnv.cmd" >nul 2>&1
...
:: RunOnce Neptune2
%WinDir%\System32\Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce" /v "Neptune" /t REG_SZ /d "%neptunemain%\neptune2.cmd" /f > nul
