...
move "C:\NeptuneOS-installer-dev\Neptune\NeptuneOS-releases\layout.xml" "%WinDir%"
move "C:\NeptuneOS-installer-dev\Neptune\NeptuneOS-releases\regjump.exe" "%WinDir%"
move "C:\NeptuneOS-installer-dev\Neptune\NeptuneOS-releases\serviwin.exe" "%WinDir%"
...
move "C:\NeptuneOS-installer-dev\Neptune\NeptuneOS-releases\ProgramData\Microsoft\User Account Pictures" "C:\ProgramData\Microsoft" >nul
takeown /f "C:\Windows\Web" /r >nul
icacls C:\Windows\Web\ /grant administrators:F /T >nul
rmdir /s /q "C:\Windows\Web" >nul
move "C:\NeptuneOS-installer-dev\Neptune\NeptuneOS-releases\Web" "%WinDir%" >nul
cls
