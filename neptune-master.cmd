...
:start
:: echo Set WshShell = WScript.CreateObject("WScript.Shell") >> c:\windows\temp\fullscreen.vbs
:: echo Dim ObjShell :Set ObjShell = CreateObject("Wscript.Shell") >> c:\windows\temp\fullscreen.vbs
:: echo ObjShell.AppActivate("Administrator:") >> c:\windows\temp\fullscreen.vbs
:: echo WshShell.AppActivate("Administrator:") >> c:\windows\temp\fullscreen.vbs
:: echo WshShell.SendKeys "{F11}">> c:\windows\temp\fullscreen.vbs
:: wscript "c:\windows\temp\fullscreen.vbs"
mode 120,40
cls
...
:: Set Wallpaper
%currentuser% Reg.exe add "HKCU\Control Panel\Desktop" /v "Wallpaper" /t REG_SZ /d "C:\Windows\NeptuneDir\neptune.png" /f >nul 2>&1
...
netsh int tcp set global dca=enable >nul 2>&1
...
:: Background Processes to Below Normal
